...
class Fingerprint:
    ...
    def to_dict(self):
        return dict(zip(self.feature_names, self.vector))
...
class FingerprintBuilder:
    def __init__(self, retained_components):
