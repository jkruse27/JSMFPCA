...
Every baseline should expose the same public API as JS-MFPCA.
...
and return the same data structures.
"""
...
def test_fingerprint_vectors_are_finite(
    Estimator,
    synthetic_dataset,
):
...
def test_returns_same_fingerprint_type(
    Estimator,
    synthetic_dataset,
):
