"""
Tests for Gaussian BLUP / posterior inference.
"""
...
def test_covariance_symmetric():
    ...
    posterior = GaussianBLUP().estimate(
        H,
        y,
        prior.covariance(),
        R,
...
def test_prediction_shape():
    ...
    mean, covariance = blup.reconstruct(
        H,
        posterior,
    )
