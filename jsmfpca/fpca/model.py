...
Stage 0 of the JS-MFPCA pipeline.

Weighted Functional PCA over the scale axis.
"""
...
class ShapeFPCA:
    ...
    def _select_n_components(self, data):
        """
        Select the number of FPCA components by grouped
    ...
    def inverse_transform(
        ...
        return reconstruct_curves(
            scores, self.mean_, self.basis_
        )
